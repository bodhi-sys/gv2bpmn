...
define([[start]], [[START_NODE [label="$1", shape=circle]dnl
define([[NODE_START_NODE]], [[1]])]])dnl
define([[end]], [[END_NODE [label="$1", shape=doublecircle]dnl
define([[NODE_END_NODE]], [[1]])]])dnl
define([[t]], [[ifdef([[NODE_$1]], [[ERROR: duplicate task node '$1'
]], [[$1 [label="$2"]dnl
define([[NODE_$1]], [[1]])]])]])dnl
define([[g_xor]], [[$1 [label="$2", shape=diamond]dnl
define([[NODE_$1]], [[1]])]])dnl
define([[g_or]], [[$1 [label="$2", shape=diamond]dnl
define([[NODE_$1]], [[1]])]])dnl
define([[g_and]], [[$1 [label="$2", shape=diamond]dnl
define([[NODE_$1]], [[1]])]])dnl
