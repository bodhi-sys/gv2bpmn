...
define([[format_label]], [[patsubst(patsubst([[[[$1]]]], [[
[	 ]*]], [[\\]]n), [[^[	 ]*]])]])dnl
define([[start]], [[define([[NODE_START_NODE]], [[1]])dnl
define([[PREFIX_START_NODE]], [[start__NODE]])dnl
get_id([[START_NODE]]) [label="format_label([[[[$1]]]])", shape=circle]]])dnl
define([[end]], [[define([[NODE_END_NODE]], [[1]])dnl
define([[PREFIX_END_NODE]], [[end__NODE]])dnl
get_id([[END_NODE]]) [label="format_label([[[[$1]]]])", shape=doublecircle]]])dnl
define([[t]], [[ifdef([[NODE_$1]], [[ERROR: duplicate task node '$1'
]], [[define([[NODE_$1]], [[1]])dnl
define([[PREFIX_$1]], [[t__$1]])dnl
get_id([[$1]]) [label="format_label([[[[$2]]]])"]]])]])dnl
define([[g_xor]], [[define([[NODE_$1]], [[1]])dnl
define([[PREFIX_$1]], [[g_xor__$1]])dnl
get_id([[$1]]) [label="format_label([[[[$2]]]])", shape=diamond]]])dnl
...
define([[g_to]], [[check_node([[$1]])check_node([[$2]])get_id([[$1]]) -> get_id([[$2]]) [label="format_label([[[[$3]]]])"]]])dnl
